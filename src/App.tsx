...
export default function App() {
  ...
  return (
    <div className={`min-h-screen font-sans flex flex-col pb-24 md:pb-0 transition-colors duration-500 selection:bg-[var(--blue)] selection:text-white ${isDarkMode ? 'dark' : ''}`} style={{ backgroundColor: 'var(--bg)', color: 'var(--fg)' }}>
      ...
      {/* Header */}
      <header className="sticky top-0 flex justify-between items-center p-4 md:px-6 border-b border-[var(--border)] relative z-50 bg-white text-black transition-colors duration-500">
        <div 
      ...
      {/* Footer */}
      <footer className="p-6 md:p-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-8 bg-white text-black border-t border-[var(--border)] transition-colors duration-500 relative z-10">
        <div>
          ...
          <div className="flex gap-3 mt-6">
            <a href="https://www.instagram.com/towguysgresham" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-black/5 border border-black/10 flex items-center justify-center hover:bg-[#E1306C] hover:border-[#E1306C] hover:text-white transition-all group" aria-label="Instagram">
              <Instagram className="w-4 h-4 group-hover:scale-110 transition-transform" />
            </a>
            <a href="https://www.facebook.com/TowGuysPortland" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-black/5 border border-black/10 flex items-center justify-center hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all group" aria-label="Facebook">
        ...
        <div className="text-left md:text-right w-full md:w-auto">
          ...
          <div className="mt-8 pt-6 border-t border-black/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 font-mono text-[10px] opacity-40 uppercase tracking-widest">
